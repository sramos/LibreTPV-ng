...
module IndexHelper
  ...
  def index_fields object_type
    ...
    when 'payments'
      [['Fecha', 'date', '1'], ['Importe', 'amount', '2_3 right'], ['Forma de pago', 'payment_type.name', '2']]
    when 'payment_types'
  ...
  def etiqueta campo
    etiqueta = {
      ...
      'product.code' => ['Código/ISBN', '1_3', 15],
      'product.name' => ['Nombre/Título', '1', 55],
      'product.price' => ['PVP', '1_4', 14, 'f'],
      'discount' => ['% Dto.', '1_5', 8, 'd'],
      'tax_base' => ['Base imponible', '1_4', 14, 'f'],
      'total_vat' => ['IVA', '1_5', 14, 'f'],
