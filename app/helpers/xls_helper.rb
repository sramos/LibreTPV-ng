...
module XlsHelper
  ...
  def crea_hoja_xls workbook, subhoja=nil
    puts "**** Vamos a crear la hoja XLS"
    puts "**** Subhoja: #{subhoja.inspect}"
    puts "**** Objetos: #{@objetos.inspect}"
    puts "**** Subobjetos: #{@subobjetos.inspect}"
    puts "**** Titulo: #{@xls_title}"
    puts "**** Cabecera: #{@xls_head}"
    puts "**** Tipo: #{@tipo}"
    puts "**** Filtrado: #{@estado_filtrado}"
    puts "**** Ordenado: #{@ordenado}"
    puts "**** Ordenado asc/desc: #{@ordenado_asc_desc}"
